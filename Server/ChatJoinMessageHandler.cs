...
namespace ChatServer
{
    public class ChatJoinMessageHandler : IObserver<Object>
    {
        ...
        {
            ClientLeaves();
            Console.WriteLine("ChatJoinMessage: Zakonczono");
        ...
        private void ClientLeaves()
        {
            ...
            {
                Broadcast(new { cls = "msg", message = _session.Nick + " opuscil pokoj.", room = _session.Room, nick = "Server", timestamp = DateTime.Now.ToString("hh:mm:ss") }, _session);
        ...
        public void OnNext(Object omsgIn)
        {
            ...
            Broadcast(new { cls = "msg", message = _session.Nick + " dolaczyl do pokoju.", room = roomName, nick = "Server", timestamp = DateTime.Now.ToString("hh:mm:ss") });
            Broadcast(new { cls = "join", room = roomName, nick = _session.Nick }, _session);
        }
    }
}